...
import Foundation
// must match JSON names & datatypes
struct MoviesResponse: Decodable  // struct for Movies API overview response
{
    let page: Int
    var results: [Movie] = []
}
// TODO: Pt 1 - Create a Movie model struct
struct Movie : Decodable // Using hardcoded data
    {
